index_web:
  ...
  config:
    ...
    INDEX_WEB_DOMAIN: "http://zone1.topvdn.com"
    INDEX_WEB_SERVER_ID: "1"
    INDEX_WEB_INDEX_PUBLIC_MONGO: "mongodb://topvdn:XwkqUz2a8cN8yAuHTMgXJAEC@2.mongodb.private:27017,1.mongodb.private:27017/?authSource=topvdn"
    ...
    INDEX_WEB_STATSD_APP_NAME: "index_web_fs"
    INDEX_WEB_SENTRY_DSN: "http://bce771c249ed44e8848616924a1b2090:2bbb9cc59792434481018a7d7829ab92@121.40.200.9:8088/2"
    ...
    INDEX_WEB_ADFS_HOST: "http://183.57.151.117:8088"

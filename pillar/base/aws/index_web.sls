index_web:
  ...
  config:
    ...
    INDEX_WEB_DOMAIN: 'http://zone9.topvdn.com'
    INDEX_WEB_SERVER_ID: '9'
    INDEX_WEB_INDEX_PUBLIC_MONGO: 'mongodb://topvdn:Megaium!@mongodb.private:27017/?authSource=topvdn'
    INDEX_WEB_INDEX_PUBLIC_MONGO_PASSWD: 'Megaium!'
    INDEX_WEB_INDEX_PRIVATE_MONGO: 'mongodb://topvdn:Megaium!@mongodb.private:27017/?authSource=topvdn'
    INDEX_WEB_INDEX_PRIVATE_MONGO_PASSWD: 'Megaium!'
    ...
    INDEX_WEB_STATSD_APP_NAME: 'index_web_aws'
    INDEX_WEB_SENTRY_DSN: 'http://61738754804545578cdbc3abb148ef44:71f9035f5cc34e9e92995fc88d22e0c6@121.40.200.9:8088/5'
    ...
    INDEX_WEB_INDEX_SYNC_MONGO: 'mongodb://topvdn:Megaium!@mongodb.private:28017/?authSource=topvdn'
    ...
    INDEX_WEB_EVENT_MONGO_URL: 'mongodb://topvdn:Megaium!@mongodb.private:27117/?authSource=camera'

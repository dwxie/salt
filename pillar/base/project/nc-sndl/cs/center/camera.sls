camera:
  config:
    CAMERA_DEBUG: "True"
    CAMERA_DOMAIN: "http://jxsr-api.antelopecloud.cn"
    CAMERA_MONGO_HOST: "mongodb://192.168.2.32:27017,192.168.2.12:27017,192.168.2.22:27017/?replicaSet=mo_psrnc"
    CAMERA_MONGO_PORT: 27017
    CAMERA_MONGO_DB_NAME: 'camera'
    CAMERA_MONGO_USER: 'camera'
    CAMERA_MONGO_PWD: 'r3aK291srKSjGihelYzoeY2Q'
    CAMERA_REDIS_HOST: '127.0.0.1'
    CAMERA_REDIS_PORT: 6800
    CAMERA_REDIS_DB: 0
    CAMERA_REDIS_PASSWD: '123456'
    CAMERA_APP_LOG_PATH: '/data/log/supervisor/camera'
    CAMERA_APP_LOG_ROTATE: 'midnight'
    CAMERA_APP_LOG_BACKUPS: 7
    CAMERA_CELERY_BROKER_URL: 'redis://:123456@127.0.0.1:6800/1'
    CAMERA_TRACKER_RELOAD_SCRIPT: '/var/www/camera/scripts/tracker_reload_state.py'
    CAMERA_TRACKER_MQ_HOST: '192.168.2.44'
    CAMERA_TRACKER_MQ_PORT: 5672
    CAMERA_TRACKER_MQ_VHOST: '/topvdn'
    CAMERA_TRACKER_MQ_USER: 'topvdn'
    CAMERA_TRACKER_MQ_PASSWD: 'PV8fYL00FykaNOdfLd53'
    CAMERA_MQ_OPTIONS: '{"passwd": "PV8fYL00FykaNOdfLd53", "vhost": "/topvdn", "host": "192.168.2.44", "user": "topvdn", "port": 5672}'
    ...
    CAMERA_INDEX_HOSTS: '{"1": ["218.95.36.50", 80]}'
    CAMERA_INDEX_TIMELINE_DBS: '{"1": {"passwd": "r3aK291srKSjGihelYzoeY2Q", "db": "topvdn", "host": "mongodb://192.168.2.32:27017,192.168.2.12:27017,192.168.2.22:27017", "replica": "mo_psrnc", "user": "topvdn", "port": 27017}}'
    CAMERA_STORAGE_AREAS: '{"1": "218.95.36.50"}'
    ...
    CAMERA_TRACKER_MQ_INFOS: '{"218.95.36.34": {"ip": "218.95.36.34", "mq": "amqp://topvdn:W1rvtlViBO3RLwklImKO@192.168.2.34:5672/%2ftopvdn?heartbeat_interval=30"},"218.95.36.43": {"ip": "218.95.36.43", "mq": "amqp://topvdn:W1rvtlViBO3RLwklImKO@192.168.2.34:5672/%2ftopvdn?heartbeat_interval=30"},"218.95.36.13": {"ip": "218.95.36.13", "mq": "amqp://topvdn:W1rvtlViBO3RLwklImKO@192.168.2.34:5672/%2ftopvdn?heartbeat_interval=30"}}'
    CAMERA_EVENT_STORAGE_MQ: 'amqp://topvdn:W1rvtlViBO3RLwklImKO@192.168.2.34:5672/%2ftopvdn?heartbeat_interval=30'
    CAMERA_INTERNAL_SERVER_APPIDS: '["sumf","kooo","qpen","fkiu","uica"]'
    CAMERA_OPS_SERVER_APPIDS: '["sumf"]'
    ...
    CAMERA_AUTH_GRANT_APPIDS: '["amvc"]'
    CAMERA_AUTH_PROVIDE_APPIDS: '["odko"]'
    CAMERA_AUTH_RECEIVE_APPIDS: '["amvc", "vnrj"]'

...
tracker:
  config:
    tracker:
      http_center_web: {host: 'http://223.202.103.142', local_ip: 223.202.103.130}
      max_peer_count: 32768
      max_relay_count: 256
      rabbitmq_message:
        exchange: tracker_msg
        queue_name: tracker_223.202.103.130_q
        routing_key: tracker_223.202.103.130
        url: ['amqp://tracker_app:Megaium!@223.202.103.142:5672']
        vhost: /tracker_app

...
relay:
  config:
    ...
    connection_config: {audio_pass_back: 1, max_download_bandwidth: 500, max_download_connections: 700,
      max_upload_bandwidth: 500, peer_id: 3221225525, relay_type: 192}
...
storage:
  local_ip: 192.168.2.222
  partitions:
  - {automount: 1, enable: 1, fs_type: ext4, server_port: 9007, wwn: '0x50014ee20cf8fbdd'}
  - {automount: 1, enable: 1, fs_type: ext4, server_port: 9008, wwn: '0x50014ee2b7a355bc'}
  - {automount: 1, enable: 1, fs_type: ext4, server_port: 9009, wwn: '0x50014ee2b7a3ecfd'}
  - {automount: 1, enable: 1, fs_type: ext4, server_port: 9010, wwn: '0x50014ee2624b698c'}
  - {automount: 1, enable: 1, fs_type: ext4, server_port: 9011, wwn: '0x50014ee2b7a3f19a'}
  - {automount: 1, enable: 1, fs_type: ext4, server_port: 9012, wwn: '0x50014ee2b7a33d49'}
  public_ip: 61.55.189.149

MachineID: 2956898620
cs:
  zone:
    nginx:
      vhosts:
        zone.topvdn.com.conf:
          server_names: [103.38.42.89, zone5.topvdn.com]
elastic:
  filebeat:
    config:
      filebeat:
...
index_web:
  config: {INDEX_WEB_BROKER_URL: 'redis://:BzpUCHeuJjr4qZFDQ9zR2JkLyXeAejQCpVArDNHQfxPTkhuh@127.0.0.1:6800/3',
    INDEX_WEB_CEPH_CONFIG: '', INDEX_WEB_CEPH_TS_POOL: event_storage, INDEX_WEB_IP: 103.38.42.89,

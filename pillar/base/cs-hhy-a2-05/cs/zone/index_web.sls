index_web:
  ...
  config:
    ...
    INDEX_WEB_DOMAIN: "http://zone5.topvdn.com"
    INDEX_WEB_SERVER_ID: "5"
    INDEX_WEB_INDEX_PUBLIC_MONGO: "mongodb://topvdn:XwkqUz2a8cN8yAuHTMgXJAEC@1.mongodb.private:27017,2.mongodb.private:27017/?authSource=topvdn"
    INDEX_WEB_INDEX_PUBLIC_MONGO_PASSWD: ""
    INDEX_WEB_INDEX_PRIVATE_MONGO: "mongodb://topvdn:XwkqUz2a8cN8yAuHTMgXJAEC@1.mongodb.private:27017,2.mongodb.private:27017/?authSource=topvdn"
    INDEX_WEB_INDEX_PRIVATE_MONGO_PASSWD: ""
    INDEX_WEB_MONGO_HOST: "mongodb://1.mongodb.private:27117,3.mongodb.private:27117,2.mongodb.private:27117/?replicaSet=index_web"
    ...
    INDEX_WEB_VIDEO_CLIP_DIR: "/data_nfs/web/download/videos"
    INDEX_WEB_STATS_REQUEST: "True"
    INDEX_WEB_STATSD_HOST: "127.0.0.1"
    INDEX_WEB_STATSD_PORT: "8125"
    INDEX_WEB_STATSD_APP_NAME: "index_web_cs"
    ...
    INDEX_WEB_ADFS_HOST: "http://103.38.42.104:8088"

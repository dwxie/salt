  ...
  WebServer:
    config:
      diskServer:
        node: 3
        storagepaths:
        - {storageroot: /data1/webserver, storageserver: '192.168.2.211:8192'}
        - {storageroot: /data2/webserver, storageserver: '192.168.2.213:8192'}
        - {storageroot: /data3/webserver, storageserver: 127.0.0.1}
  codispatcher:
    config:
      general: {rpcServer: 192.168.2.213}
  filedelete:
    config:
